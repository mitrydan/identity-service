...
namespace IdentityService.Api.Controllers
{
    ...
    [ApiController]
    public class IdentityResourceController : CrudControllerBase<ConfigurationDbContext, IdentityResource>
    {
        public IdentityResourceController(ConfigurationDbContext dbContext)
            : base(dbContext)
        { }
    }
}
